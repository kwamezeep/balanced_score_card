...
if(isset($_POST['save']))
{
	 ...
	 $sql = "UPDATE feb19 SET value=$value1 WHERE id=1";
	 $sql2 = "UPDATE feb19 SET value=$value2 WHERE id=2";
	 $sql3 = "UPDATE feb19 SET value=$value3 WHERE id=3";
	 $sql4 = "UPDATE feb19 SET value=$value4 WHERE id=4";
	 $sql5 = "UPDATE feb19 SET value=$value5 WHERE id=5";
	 $sql6 = "UPDATE feb19 SET value=$value6 WHERE id=6";
	 $sql7 = "UPDATE feb19 SET value=$value7 WHERE id=7";
	 $sql8 = "UPDATE feb19 SET value=$value8 WHERE id=8";
	 $sql9 = "UPDATE feb19 SET value=$value9 WHERE id=9";
	 $sql10 = "UPDATE feb19 SET value=$value10 WHERE id=10";
	 $sql11 = "UPDATE feb19 SET value=$value11 WHERE id=11";
	 $sql12 = "UPDATE feb19 SET value=$value12 WHERE id=12";
	 $sql13 = "UPDATE feb19 SET value=$value13 WHERE id=13";
	 $sql14 = "UPDATE feb19 SET value=$value14 WHERE id=14";
	 $sql15 = "UPDATE feb19 SET value=$value15 WHERE id=15";
	 $sql16 = "UPDATE feb19 SET value=$value16 WHERE id=16";
	 $sql17 = "UPDATE feb19 SET value=$value17 WHERE id=17";
	 $sql18 = "UPDATE feb19 SET value=$value18 WHERE id=18";
	 $sql19 = "UPDATE feb19 SET value=$value19 WHERE id=19";
	 $sql20 = "UPDATE feb19 SET value=$value20 WHERE id=20";
	 $sql21 = "UPDATE feb19 SET value=$value21 WHERE id=21";
...
<html lang="en">
  ...
  <tbody>
    <tr>
      ...
      <td><input type="text" class="form-control" id="testID"name="value1" aria-describedby="basic-addon1"></td>
      <td>10%</td>
    </tr>
    ...
    <tr>
      ...
      <td><input type="text" class="form-control" placeholder="" name="value21" aria-describedby="basic-addon1"></td>
      <td>2.5%</td>
    </tr>
  </tbody>
</table>
        ...
        <div class="col-lg-6 text-left align-items-baseline">
          ...
          <div class="col-lg-6 text-right align-items-baseline">
            <div class="">
              <span><textarea type="text" rows="4" cols="50" id="comments" placeholder="comments" class="ml-3"></textarea></span>
            </div>
            <button type="submit" name="save" id="submit" class="btn btn-primary"> Save</button> <br><br>
          </div>
          </form>
